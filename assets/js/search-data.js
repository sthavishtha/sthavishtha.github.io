    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-we-will-present-three-talks-in-the-interact-sessions-mechanisms-modeling-and-measurement-of-convective-transport-in-the-environment-and-porous-media-flows-from-ice-in-the-soil-to-spinal-fluid-in-the-brain-at-the-79th-aps-division-of-fluid-dynamics-dfd-annual-meeting-2026",
          title: 'We will present three talks in the Interact sessions Mechanisms, Modeling, and Measurement...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=1xy4ycEAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/sthavishtha", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-7221-695X", "_blank");
        },
      },{
      id: 'light-theme',
